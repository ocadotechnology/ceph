			       ...
			       string *start, string *end)
{
  ...
  *temp_end = *start;
  ...
  _key_encode_u64(pgid.pool() + 0x8000000000000000ull, temp_end);

  uint64_t end_hash;
  if (cid.is_meta()) {
    end_hash = 0x100000000;
  } else {
    end_hash = hobject_t::_reverse_bits(pgid.ps());
